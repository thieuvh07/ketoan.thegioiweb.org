...
class ConfigBie{
	...
	public function data($field = 'process', $value = -1){
		...
		$data['order_by_product'] = array(
			...
			'quantity_opening_stock=ASC' => 'Tồn đầu kì (ít nhất)',
			'quantity_opening_stock=DESC' => 'Tồn đầu kì (Nhiều nhất)',

			'quantity_closing_stock=ASC' => 'Tồn cuối kì (ít nhất)',
			'quantity_closing_stock=DESC' => 'Tồn cuối kì (Nhiều nhất)',

			'total_price=ASC' => 'Tổng tiền (ít nhất)',
			'total_price=DESC' => 'Tổng tiền (Nhiều nhất)',

			'price_output=ASC' => 'Giá bán (ít nhất)',
			'price_output=DESC' => 'Giá bán (Nhiều nhất)',
			'created=DESC' => 'Ngày tạo (Mới nhất)',
			'created=ASC' => 'Ngày tạo (Cũ nhất)',
			'updated=DESC'=> 'Ngày cập nhật (Mới dần)',
			'updated=ASC' => 'Ngày cập nhật (Cũ dần)',
