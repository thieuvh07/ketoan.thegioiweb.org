...
<body class="gray-bg">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    ...
                    ?>
                    <?php 
                        echo (!empty($message) && isset($message)) ? '<div class="alert alert-danger">'.$message.'</div>' : '';
                    ?>
                    <form class="m-t js_check_login js_check_login" role="form" method="post" action="">
    ...
    <script src="template/backend/libraryjs/auth.js"></script>
</body>
