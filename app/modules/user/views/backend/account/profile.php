<div id="page-wrapper" class="gray-bg dashbard-1">
	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			<h2>Hồ sơ thành viên: <?php echo $moduleDetail['fullname']; ?></h2>
			<ol class="breadcrumb">
				<li>
							...
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_hidden('account_original', htmlspecialchars_decode(html_entity_decode(set_value('account_original', $moduleDetail['account']))), 'class="form-control" readonly="true" placeholder="" autocomplete="off"');?>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-row">
							...
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_hidden('email_original', htmlspecialchars_decode(html_entity_decode(set_value('email_original', $moduleDetail['email']))), 'class="form-control" readonly="true" placeholder="" autocomplete="off"');?>
									</div>
								</div>
								<?php 
								...
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_dropdown('catalogueid', $dropdown, set_value('catalogueid', $moduleDetail['catalogueid']), 'class="form-control m-b city"');?>
									</div>
								</div>
							</div>
							<div class="row mb15">
								<div class="col-lg-6">
									<div class="form-row">
										...
										<?php echo form_input('birthday', set_value('birthday', gettime($moduleDetail['birthday'],'d/m/Y')), 'class="form-control datetimepicker" placeholder="" autocomplete="off"');?>
									</div>
								</div>
							</div>
							<?php 
