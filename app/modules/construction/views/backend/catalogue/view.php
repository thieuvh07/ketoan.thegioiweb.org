<div id="page-wrapper" class="gray-bg dashbard-1 js_load_view">
	<div class="row border-bottom">
	 ...
	 <div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			<h2>Quản lý nhóm công trình</h2>
			<ol class="breadcrumb">
				<li>
					<a href="<?php echo site_url('admin'); ?>">Home</a>
				</li>
				<li class="active"><strong>Quản lý nhóm công trình</strong></li>
			</ol>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Danh sách nhóm công trình</h5>
						...
						<div class="uk-flex uk-flex-middle uk-flex-space-between m-b">
							...
							<div class="toolbox">
								<div class="uk-flex uk-flex-middle uk-flex-space-between">
									<div class="uk-button">
										<a href="<?php echo site_url('construction/backend/catalogue/create'); ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm nhóm công trình mới</a>
									</div>
								</div>
							</div>
						</div>
							...
							<table class="table table-striped table-bordered table-hover dataTables-example" >
								<thead>
									<tr>
										...
										<th class="text-center">Phần trăm cho thợ</th>
