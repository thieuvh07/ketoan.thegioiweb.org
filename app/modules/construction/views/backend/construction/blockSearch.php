	...
	<div class="uk-flex uk-flex-middle uk-flex-space-between m-b-sm">
		...
		<div class=" col-lg-3 p-r-none">
			<div class="uk-button uk-flex uk-flex-space-between">
				<div></div>
				<div>
				<a href="<?php echo site_url('construction/backend/construction/create') ?>" class="btn btn-danger btn-sm m-r"><i class="fa fa-plus"></i> Thêm đơn hàng</a></div>
			</div>
		</div>
	</div>
	<div class="uk-flex uk-flex-middle uk-flex-space-between m-b-sm" >
		...
		<div class="col-sm-3">
			<label for="">Chọn NV kinh doanh</label>
