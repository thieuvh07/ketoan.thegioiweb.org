	...
	<div class="uk-flex uk-flex-middle uk-flex-space-between m-b-sm">
		<div class="col-sm-3 p-l-none">
			<div class="col-sm-6 p-l-none">
				<?php echo form_dropdown('perpage', $this->configbie->data('perpage'), set_value('perpage',$this->input->get('perpage')) ,'class="form-control height-32 js_perpage m-r" data-url="'.site_url('import/backend/import/view').'"'); ?>
			</div>
		...
		<div class="col-sm-3 p-r-none text-right">
			<a href="<?php echo site_url('import/backend/import/excel') ?>" class="btn btn-info btn-sm"> Xuất exel</a>
			<a href="<?php echo site_url('import/backend/import/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm đơn nhập</a>
		</div>
	</div>
	<div class="uk-flex uk-flex-middle uk-flex-space-between m-b-sm" >
		<div class="col-sm-3 p-l-none">
		...
		<div class="col-sm-3">
			<label for="">Mã đơn nhập</label>
			<?php echo form_input('code', set_value('code',$this->input->get('code')), 'class="form-control " placeholder="Nhập mã đơn nhập" autocomplete="off"');?>
		</div>
