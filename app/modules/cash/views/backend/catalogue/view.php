<div id="page-wrapper" class="gray-bg dashbard-1 js_load_view">
	<div class="row border-bottom">
	 ...
	 <div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			<h2>Quản lý nhóm tiền mặt</h2>
			<ol class="breadcrumb">
				<li>
					<a href="<?php echo site_url('admin'); ?>">Home</a>
				</li>
				<li class="active"><strong>Quản lý nhóm tiền mặt</strong></li>
			</ol>
		</div>
	</div>
						...
						<div class="uk-flex uk-flex-middle uk-flex-space-between m-b">
							...
							<div class="toolbox">
								<div class="uk-flex uk-flex-middle uk-flex-space-between">
									<div class="uk-button">
										<a href="<?php echo site_url('cash/backend/catalogue/create'); ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm nhóm tiền mặt mới</a>
									</div>
								</div>
							</div>
						</div>
