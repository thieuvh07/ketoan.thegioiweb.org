...
<div id="page-wrapper" class="gray-bg dashbard-1 js_load_create">
	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="row">
        	...
        	<form method="post" role="form" action="" class="form-horizontal product js_create">
				<div class="ibox ">
					...
					<div class="row">
		           	...
		           	<div class="ibox-title">
						<div class="uk-flex uk-flex-middle uk-flex-space-between">
							<div></div>
							<div class="uk-button">
								<button style="margin-right:2px;" class="btn btn-primary btn-sm" name="create" value="create" type="submit">Thêm mới sản phẩm</button>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<small class="font-bold text-danger">Thêm mới đầy đủ thông tin người dùng giúp việc quản lý dễ dàng hơn</small>
				</div>
