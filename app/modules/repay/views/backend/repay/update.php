						...
						<div class="row m-b-xs">
							<div class="col-md-3">
								<div class="input-group icon-left">
									...
									<div class="js_dropdown" data-name="supplierid" data-module="supplier" data-text="Chọn NCC" data-value="title" data-disable="true" data-checked="<?php echo $moduleDetail['supplierid'] ?>"></div>
	                                <ul id="list-supplier">
	                                </ul>
	                            </div>
							</div>
							...
							<div class="col-md-3">
								<div class="input-group">
	                               <?php echo form_input('code', 'Mã đơn: '.$moduleDetail['code'], 'class="form-control " placeholder="Mã đơn trả hàng" autocomplete="off" readonly');?>
	                            </div>
	                        </div>
							<div class="col-md-3">
                        	...
                        	<table class="table">
	                            <thead>
		                            <tr class="">
		                                ...
		                                <th>Tên SP</th>
		                                <th style="width:70px">SL trả</th>
		                                <th style="width:70px">Đơn vị trả</th>
	                            ...
	                            <tbody class="js_content">
		                            ...
		                            <tr>
								        ...
								        <td>
								        	<div class="input-group">
								        		<input type="text" style="height: 25px " name="product[quantity_repay][]" value="<?php echo $val['quantity_repay'] ?>" class="float text-right form-control" autocomplete="off">
								            </div>
								        </td>
								        <td>
								        	<div class="input-group">
								        		<input type="text" style="height: 25px " name="product[measure_repay][]" value="<?php echo $val['measure_repay'] ?>" class="text-right form-control" autocomplete="off">
								            </div>
								        </td>
								        <td>
								        	<div class="input-group">
