            ...
            <div class="col-sm-12" style="padding-left:0;padding-right:0;">
                ...
                <div class="ibox">
						...
						<div class="row m-b-xs">
							...
							<div class="col-md-3">
								<div class="input-group">
	                               <?php echo form_input('code', $moduleDetail['code'], 'class="form-control " placeholder="Mã đơn trả hàng" autocomplete="off" readonly');?>
	                            </div>
	                        </div>
							<div class="col-md-3">
                        	...
                        	<table class="table" >
	                            <thead>
		                            <tr class="">
		                                ...
		                                <th style="width:100px">Giá trả</th>
                    ...
                    <div class="ibox-title	">
                    	<div class="row">
                    		<div class="col-md-6">
                    			<?php echo form_textarea('note', set_value('note'), 'class="form-control m-b-xs" placeholder="Ghi chú đơn trả" style="height: 70px"  ');?>
                    		</div>
                    		<div class="col-md-6">
